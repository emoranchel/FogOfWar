...
import net.edzero.fow.impl.SimpleFogOfWar;
      ...
      public void run() {
        try {
          ...
          while (true) {
            ...
            FogOfWar fogOfWar = (FogOfWar) Class.forName(fogImpl).newInstance();
            fogOfWar.initialize(FogOfWarMap.getWidth(), FogOfWarMap.getHeight());
            ...
            for (int[] thing : things) {
              fogOfWar.addPointOfView(thing[0], thing[1], thing[2]);
            }
